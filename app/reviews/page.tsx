  ...
  return (
    <div className="space-y-10 py-8">
      ...
      <div className="space-y-6">
        {RECENT_REVIEWS_MOCK.map((review) => {
              ...
              <div className="flex flex-col gap-4 p-5 sm:p-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 border-t border-white/10 pt-4 text-sm text-gray-400">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-gray-200 transition hover:bg-white/10">
                      Like
                    </button>
                    <button className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-gray-200 transition hover:bg-white/10">
                      Share
