      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <button onClick={toggleLike}
            className={`bg-brand-surface border rounded-lg p-4 text-center transition group shadow-md cursor-pointer ${liked ? 'border-brand-primary-button/30 bg-brand-primary-button/10' : 'border-white/5 hover:border-brand-primary-button/30'}`}>
            <div className="text-2xl mb-2 group-hover:scale-110 transition">{liked ? '❤️' : '👍'}</div>
          ...
          <button onClick={() => alert('Report submitted. Our team will review this content.')}
